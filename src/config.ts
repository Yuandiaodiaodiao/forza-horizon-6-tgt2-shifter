...
export type ShiftMode = "keyboard" | "vjoy";
...
export function loadConfig(): AppConfig {
  ...
  const mode = shift.shift_mode === "keyboard" || shift.shift_mode === "vjoy"
    ? shift.shift_mode
...
export function updateConfig(patch: Partial<AppConfig>): AppConfig {
  ...
  if (next.shiftMode !== "keyboard" && next.shiftMode !== "vjoy") next.shiftMode = DEFAULT_CONFIG.shiftMode;
